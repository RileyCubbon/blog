                            ...
                            <tr>
                                <td class="content-cell"
                                    ...
                                    <p style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; color: #74787E; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">
                                        您收到这封电子邮件是因为我们收到您申请账号到请求，如果确实是您到申请操作，请点击下方的 "点击验证" 按钮进行邮箱验证
                                    </p>
                                    ...
                                    <p style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; color: #74787E; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">
                                    如果您并没有在 Riley 到博客申请账号，则不需要采取进一步到操作
                                    </p>
                                    <p style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; color: #74787E; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">
                                        问候您,<br>riley</p>
                                        ...
                                        <tr>
                                            <td style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box;">
                                                <p style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; color: #74787E; line-height: 1.5em; margin-top: 0; text-align: left; font-size: 12px;">
                                                    如果您在点击“点击验证”按钮时遇到问题，请将以下网址复制并粘贴到您的网络浏览器中: <a href="{{ $url }}" style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; color: #3869D4;"></a><a href="" style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; color: #3869D4;">
                                                        {{ $url }}
                                                    </a>
                                                </p>
                                            </td>
